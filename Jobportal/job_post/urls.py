...
from .views import JobListCreateView, JobDetailView, JobApplicationView, MyPostedJobsView, JobApplicantsView, MyAppliedJobsView, UpdateApplicationStatusView, ApplicationStatusStatsView, UserPermissionsView
